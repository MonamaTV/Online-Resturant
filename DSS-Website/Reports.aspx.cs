...
namespace DSS_Website
{
    public partial class Reports : System.Web.UI.Page
    {
        ...
        private void DisplayByCategory(string category)
        {
            ...
            averageUsers.InnerText += Math.Round(service.AverageUsersPerDay(), 2);
        }
        ...
        private void Top5WishedItems()
        {
            ...
            display += "datasets: [{";
            display += "label: 'Most Wished Items',";
            ...
            foreach(SVCProduct pro in service.TopFiveMostWishedItems())
            {
                ...
                items += $"<td> <a href='WishingCustomers.aspx?ProdID='{pro.ProductID}' class='edit'>Show</a></td>";
                items += "</tr>";
                count++;
                if (count >= 5) break;
