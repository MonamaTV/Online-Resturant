            ...
            <div class="row">
                <div class="col-md-12 login-bg">
                    <form runat="server" class="login-form m-auto">
                        ...
                        <span id="register" ><a class="text-center" href="ForgotPassword.aspx">Forgot password? Reset it</a></span>
                        <br />
                        <div class="media">
                            <a href="htpps://www.google.com" class="google-sign-in">Sign In With Google<i class="fab fa-google"></i></a>  
                        </div>
                        <br />
                    </form>
                </div>
