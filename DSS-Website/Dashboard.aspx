    ...
    <div class="container">
        <form id="menuDrop" runat="server">
           <div class="row">
               <div class="col-md-4">
                   <div class="dash-card text-center">        
                       ...
                       <asp:DropDownList ID="revenueMenu" runat="server" class="dropdowntype" OnSelectedIndexChanged="revenueMenu_SelectedIndexChanged" AutoPostBack="true">
                            <asp:ListItem Enabled="true" Text="Revenue" Value="-1"></asp:ListItem>
                           ...
                           <asp:ListItem Text="Last 365 days" Value="4"></asp:ListItem>
                        </asp:DropDownList>
               ...
               <div class="col-md-4">
                   <div class="dash-card text-center">
                       <i class="fas fa-paste"></i>
                            ...
                            <asp:ListItem Enabled="true" Text="Orders" Value="-1"></asp:ListItem>
                            <asp:ListItem Text="Today" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Last 7 days" Value="2"></asp:ListItem>
                            <asp:ListItem Text="Last 30 days" Value="3"></asp:ListItem>
                           <asp:ListItem Text="Last 365 days" Value="4"></asp:ListItem>
               ...
               <div class="col-md-4">
                   <div class="dash-card">
                       <h5 class="text-center"><i class="fas fa-user"></i>Users</h5>
                       <hr>
